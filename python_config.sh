...
EXPECTED_PATHS="$script_path/python/python_include"\
" $script_path/python/python_lib"
...
function setup_python {
  ...
  ln -sf "${python_include}" python/python_include
  ln -sf "${python_lib}" python/python_lib
