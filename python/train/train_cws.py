...
tf.app.flags.DEFINE_string('test_data_path', "newcorpus/2014_test.txt",
                           'Test data dir')
tf.app.flags.DEFINE_string('log_dir', "log1s", 'The log  dir')
...
tf.app.flags.DEFINE_integer("batch_size", 1000, "num example per mini batch")
...
#模型并行参数fellow
tf.app.flags.DEFINE_string("ps_hosts", "localhost:2223,localhost:2224", "ps hosts")
tf.app.flags.DEFINE_string("worker_hosts", "localhost:2222,localhost:2225,localhost:2226,localhost:2227", "worker hosts")
tf.app.flags.DEFINE_string("job_name", "worker", "'ps' or'worker'")
tf.app.flags.DEFINE_integer("task_index", 0, "Index of task within the job")
tf.app.flags.DEFINE_integer("num_workers", 4, "Number of workers")
tf.app.flags.DEFINE_boolean("sync_replicas", False, "using synchronous training or not")
tf.app.flags.DEFINE_boolean("num_gpus", 0, "local host gpu number")
