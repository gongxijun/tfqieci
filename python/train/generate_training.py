...
import sys
#sys.path.insert(0,"/data1/xijun1/tfqieci/output/lib")
import os
import codecs
#import w2v
import  word2vec_vob as w2v
#import basic_vocab  as b2v
...
def main(argc, argv):
	...
	for file in fileList:
            if file.endswith(".txt"):
                ...
                fp = codecs.open(curFile, "r", "utf-8")
    ...
    out.close()
    #vob.DumpBasicVocab("/data1/xijun1/tfqieci/models/cbasic_vocab.txt")
